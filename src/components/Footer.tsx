    ...
    <footer id="global-footer" className="bg-primary text-white py-16 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="text-center md:text-left space-y-1">
          ...
          <p className="font-mono text-[10px] text-white/70 tracking-wider uppercase">
        ...
        {!isCorporateSite && (
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs font-mono">
            <a
              href="/projects/"
              className="text-white/70 hover:text-accent-orange hover:scale-105 transition-all py-1 px-2 border border-white/5 hover:border-accent-orange/20 rounded-md bg-white/[0.01]"
            >
              Projects
            </a>
            <a
              href="/travel/"
              className="text-white/70 hover:text-accent-blue hover:scale-105 transition-all py-1 px-2 border border-white/5 hover:border-accent-blue/20 rounded-md bg-white/[0.01]"
            >
              Travel Curation
            </a>
            <a
